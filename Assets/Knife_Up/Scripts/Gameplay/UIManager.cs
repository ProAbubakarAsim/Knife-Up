...
public class UIManager : MonoBehaviour {
    ...
    private void GameManager_GameStateChanged(GameState obj)
    {
        ...
        else if (obj == GameState.Playing)
        {
            ...
            else
            {
                ...
                stateTxt.text = "State: " + StateManager.Instance.CurrentState.ToString();
            }
    ...
    void Start () {
        ...
        Debug.Log("Game Play Scene is Loaded");
    ...
    private IEnumerator ShowGameOverUI(float delay)
    {
        ...
        highestStateTxt.text = "HIGHEST STATE: " + StateManager.Instance.HighestState.ToString();
